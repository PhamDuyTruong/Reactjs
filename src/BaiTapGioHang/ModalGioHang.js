        ...
        <div className="modal-dialog" role="document">
          <div className="modal-content" style = {{width:"800px"}}>
            <div className="modal-header">
              <h5 className="modal-title text-success">Sản phẩm đã chọn</h5>
              <button
                type="button"
                className="close"
                data-dismiss="modal"
                        ...
                        {gioHang.map((spGH, index) =>{
                            return(
                                <tr key={index}>
                                    ...
                                    <td>{spGH.tenSP}</td>
                                    <td>
                                        <button className="btn btn-secondary" onClick={() => tangGiamSoLuong(spGH.maSP,true)}>+</button>
                                        {spGH.soLuong}
                                        <button className="btn btn-secondary" onClick={() =>tangGiamSoLuong(spGH.maSP,false)}>-</button>
                                    </td>
